    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <div className="resume-container">
        <span className="centered-text">
          ...
          <div>
            Hover or click anything with a shadow to view more information!
          </div>
        </span>
        ...
        <div>
          <span className="bolded-text">Frameworks: </span>
            ...
            {EasyHoverCard(resumeData.azure.target, resumeData.azure.dropdown)}
            {EasyHoverCard(resumeData.express.target, resumeData.express.dropdown)}
        ...
        <div>
          <span className="bolded-text">Skills: </span>
            ...
            {EasyHoverCard(resumeData.leadership.target, resumeData.leadership.dropdown)}
        </div>
