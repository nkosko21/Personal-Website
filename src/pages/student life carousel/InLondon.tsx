            ...
            <div className='row' style={{ justifyContent: 'space-between'}}>
                <div className='col'>
                    ...
                    <p>
                        ...
                        During my time here I took classes on the London culture and the fundamentals of computer science, using DrRacket to learn the building
                        blocks of function oriented languages. I was also elected as a Student Coordinator on the Student government board 
