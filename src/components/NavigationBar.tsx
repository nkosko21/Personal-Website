...
import { IconHome, IconCamera, IconFolder, IconDeviceLandlinePhone, IconPaperBag } from '@tabler/icons-react';
    ...
    <div className='nav-bar' >
      ...
      >
        ...
        >
          ...
          <Link to='/resume'>
            <Tabs.Tab value="resume" leftSection={<IconPaperBag/>} className='tab'>Resume</Tabs.Tab>
          </Link>
          <Link to='/contact'>
